...
model_all_agb_kf<-train(y = learn_all_agb$AGB.2,
                        ...
                        method="rf",
                        trControl=fitcontrol1,tuneGrid=tunegrid,ntree=500)
...
model_all_agb_west_kf<-train(y = learn_all_agb_west$AGB.2,
                        x = learn_all_agb_west[,colnames(learn_all_agb_west)!= "AGB.2"],
                        method="rf",
                        trControl=fitcontrol1,tuneGrid=tunegrid,ntree=500)

print(model_all_agb_west_kf)
varImp(model_all_agb_west_kf)
model_all_agb_west_kf$finalModel
...
model_all_seed_west_kf<-train(y = learn_all_seed_west$Seed_count.2,
                         x = learn_all_seed_west[,colnames(learn_all_seed_west)!= "Seed_count.2"],
                         method="rf",
                         trControl=fitcontrol1,tuneGrid=tunegrid,ntree=500)

print(model_all_seed_west_kf)
varImp(model_all_seed_west_kf)
model_all_seed_west_kf$finalModel
...
model_fire_agb_west_kf<-train(y = learn_fire_agb_west$AGB.2,
                         x = learn_fire_agb_west[,colnames(learn_fire_agb_west)!= "AGB.2"],
                         method="rf",
                         trControl=fitcontrol1,tuneGrid=tunegrid,ntree=1000)

print(model_fire_agb_west_kf)
varImp(model_fire_agb_west_kf)
model_fire_agb_west_kf$finalModel
...
model_fire_seed_west_kf<-train(y = learn_fire_seed_west$Seed_count.2,
                          x = learn_fire_seed_west[,colnames(learn_fire_seed_west)!= "Seed_count.2"],
                          method="rf",
                          trControl=fitcontrol1,tuneGrid=tunegrid,ntree=1000)

print(model_fire_seed_west_kf)
varImp(model_fire_seed_west_kf)
model_fire_seed_west_kf$finalModel
...
model_cut_agb_west_kf<-train(y = learn_cut_agb_west$AGB.2,
                        x = learn_cut_agb_west[,colnames(learn_cut_agb_west)!= "AGB.2"],
                        method="rf",
                        trControl=fitcontrol1,tuneGrid=tunegrid,ntree=500)

print(model_cut_agb_west_kf)
varImp(model_cut_agb_west_kf)
model_cut_agb_west_kf$finalModel
...
model_cut_seed_west_kf<-train(y = learn_cut_seed_west$Seed_count.2,
                         x = learn_cut_seed_west[,colnames(learn_cut_seed_west)!= "Seed_count.2"],
                         method="rf",
                         trControl=fitcontrol1,tuneGrid=tunegrid,ntree=500)

print(model_cut_seed_west_kf)
varImp(model_cut_seed_west_kf)
model_cut_seed_west_kf$finalModel
...
model_ins_agb_west_kf<-train(y = learn_ins_agb_west$AGB.2,
                        x = learn_ins_agb_west[,colnames(learn_ins_agb_west)!= "AGB.2"],
                        method="rf",
                        trControl=fitcontrol1,tuneGrid=tunegrid,ntree=500)

print(model_ins_agb_west_kf)
varImp(model_ins_agb_west_kf)
model_ins_agb_west_kf$finalModel
...
model_ins_seed_west_kf<-train(y = learn_ins_seed_west$Seed_count.2,
                         x = learn_ins_seed_west[,colnames(learn_ins_seed_west)!= "Seed_count.2"],
                         method="rf",
                         trControl=fitcontrol1,tuneGrid=tunegrid,ntree=3000)

print(model_ins_seed_west_kf)
varImp(model_ins_seed_west_kf)
model_ins_seed_west_kf$finalModel
...
saveRDS(model_cut_agb_west_kf, file=paste0("model_west_cut_agb_kf_",curr_date,".RDS"))
saveRDS(model_fire_agb_west_kf, file=paste0("model_west_fire_agb_kf_",curr_date,".RDS"))
saveRDS(model_all_agb_west_kf, file=paste0("model_west_all_agb_kf_",curr_date,".RDS"))
saveRDS(model_ins_agb_west_kf, file=paste0("model_west_ins_agb_kf_",curr_date,".RDS"))


saveRDS(model_cut_seed_west_kf, file=paste0("model_west_cut_seed_kf_",curr_date,".RDS"))
saveRDS(model_fire_seed_west_kf, file=paste0("model_west_fire_seed_kf_",curr_date,".RDS"))
saveRDS(model_all_seed_west_kf, file=paste0("model_west_all_seed_kf_",curr_date,".RDS"))
saveRDS(model_ins_seed_west_kf, file=paste0("model_west_ins_seed_kf_",curr_date,".RDS"))
