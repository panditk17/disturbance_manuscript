...
curr_date<-Sys.Date()
# saveRDS(model_insdis_agb_kf, file=paste0("model_east_insdis_agb_kf_",curr_date,".RDS"))
...
# model_east_insdis_agb_kf<-readRDS(file=paste0("model_east_insdis_agb_kf_",curr_date,".RDS"))
# saveRDS(model_cut_agb_kf, file=paste0("model_east_cut_agb_kf_",curr_date,".RDS"))
# saveRDS(model_fire_agb_kf, file=paste0("model_east_fire_agb_kf_",curr_date,".RDS"))
# saveRDS(model_all_agb_kf, file=paste0("model_east_all_agb_kf_",curr_date,".RDS"))
...
curr_date<-Sys.Date()
# saveRDS(model_insdis_seed_kf, file=paste0("model_east_insdis_seed_kf_",curr_date,".RDS"))
