...
write.csv(disdis,"plots_dist_type_all_nofilter.csv")
...
write.csv(sdam3,"all_plots_data_with_seedling_8_27.csv")
write.csv(sdam3f,"plots_data_with_seedling_f_6_4.csv")
