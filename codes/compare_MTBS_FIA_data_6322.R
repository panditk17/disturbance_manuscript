...
pdam16_first<-pdam16
write.csv(pdam16_first,"pdam16_first_all_pre.csv")
...
plots_first<-read.csv("pdam16_first_all_pre.csv")
plots_first$time<-"1"
...
plot2<-plot1[(plot1$SRV_CN %in% survey_sel2$ï..CN),]

plot(plots_all$meas_yr_diff,plots_all$REMPER.2)
...
colnames(plots_seed_n2)[52]<-"seed_count.1"
colnames(plots_seed_n2)[53]<-"sd_spp_rich.1"
colnames(plots_seed_n2)[54]<-"seed_count_con.1"
colnames(plots_seed_n2)[55]<-"sd_spp_rich_con.1"
colnames(plots_seed_n2)[57]<-"seed_count.2"
colnames(plots_seed_n2)[58]<-"sd_spp_rich.2"
colnames(plots_seed_n2)[59]<-"seed_count_con.2"
colnames(plots_seed_n2)[60]<-"sd_spp_rich_con.2"
...
sdam3_sev1<-sdam3_sev[which(sdam3_sev$AGB.2<50),]
...
table_dist_sev_west<-count(sdam3b,dist_type, fia_sev)

table_dist_sev_east<-count(sdam3a,dist_type, fia_sev)
...
write.csv(table_dist_sev_west,"tabl_dist_sev_west.csv")
write.csv(table_dist_sev_east,"tabl_dist_sev_east.csv")

write.csv(table_dist_sev_west_f,"tabl_dist_sev_west_f.csv")
write.csv(table_dist_sev_east_f,"tabl_dist_sev_east_f.csv")

write.csv(sdam3,"plots_data_with_seedling_6_4.csv")

sdam3<-read.csv("plots_data_with_seedling_6_4.csv")
...
sdam3_sev<-sdam3[which(sdam3$mtbs_sev==1),]
sdam3_mild<-sdam3[which(sdam3$mtbs_sev==0),]
plot(sdam3_sev$AGB.2)
...
table_dist_sev_west<-count(sdam3b,dist_type, mtbs_sev)

table_dist_sev_east<-count(sdam3a,dist_type, mtbs_sev)


table_dist_sev_west_f<-count(sdam3fb,dist_type, mtbs_sev)

table_dist_sev_east_f<-count(sdam3fa,dist_type, mtbs_sev)


write.csv(table_dist_sev_west,"tabl_dist_sev_west_mtbs.csv")
write.csv(table_dist_sev_east,"tabl_dist_sev_east_mtbs.csv")

write.csv(table_dist_sev_west_f,"tabl_dist_sev_west_mtbs_f.csv")
write.csv(table_dist_sev_east_f,"tabl_dist_sev_east_mtbs_f.csv")

write.csv(sdam3,"plots_data_with_fia_mtbs_seedling_7_14.csv")

sdam3<-read.csv("plots_data_with_fia_mtbs_seedling_7_14.csv")
