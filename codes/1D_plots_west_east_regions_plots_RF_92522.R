...
plots_all$ecocode <- trimws(plots_all$Spl_1, which = c("left"))

source("../data/FTGC.R")
sdam3$FOR_GRP<-FTGC(sdam3$FORTYPCD.1)

library(operators)
plots_west<-plots_all[(plots_all$ecocode %in% ecosel$econew),]
plots_east<-plots_all[(plots_all$ecocode %!in% ecosel$econew),]


kkk<-count(plots_west,dist_type,time,fia_sev1)
kkk2<-table(plots_west$dist_type,plots_west$time,plots_west$fia_sev1)


mmm<-count(plots_east,dist_type,time,fia_sev1)
mmm2<-table(plots_east$dist_type,plots_east$time,plots_east$fia_sev1)

write.csv(kkk2,"west_data_table.csv")
...
print(levels(model_cut_agb_kf$trainingData$Pre_dist_AGB))
print(levels(learn_cut_agb_west$Pre_dist_AGB))

library(pdp)


library(randomForest)
learn_cut_agb$Pre_dist_AGB<-as.numeric(learn_cut_agb$Pre_dist_AGB)
...
fire_pd_seed_count1<-as.data.frame(partialPlot(model_fire_seed_kf$finalModel, learn_fire_seed, Pre_dist_seed_count, which.class, 
                                              plot = TRUE, add = FALSE,
...
cut_pd_seed_count1<-as.data.frame(partialPlot(model_cut_seed_kf$finalModel, learn_cut_seed, Pre_dist_seed_count, which.class, 
                                             plot = TRUE, add = FALSE,
...
rm(list = setdiff(ls(), c('fire_pd_agb1','cut_pd_agb1',
                          'fire_pd_stage1','cut_pd_stage1',
                          'fire_pd_seed_count1','cut_pd_seed_count1',
                          'fire_pd_seed_age1','cut_pd_seed_age1',
...
fire_pd_agb3<-as.data.frame(partialPlot(model_fire_agb_kf$finalModel, learn_fire_agb_west, Pre_dist_AGB, which.class, 
                                        plot = TRUE, add = FALSE,
...
cut_pd_agb3<-as.data.frame(partialPlot(model_cut_agb_kf$finalModel, learn_cut_agb_west, Pre_dist_AGB, which.class, 
                                       plot = TRUE, add = FALSE,
...
ins_pd_agb3<-as.data.frame(partialPlot(model_ins_agb_kf$finalModel, learn_ins_agb_west, Pre_dist_AGB, which.class,
                                       plot = TRUE, add = FALSE,
...
fire_pd_stage3<-as.data.frame(partialPlot(model_fire_agb_kf$finalModel, learn_fire_agb_west, Post_dist_stand_age, which.class, 
                                          plot = TRUE, add = FALSE,
...
cut_pd_stage3<-as.data.frame(partialPlot(model_cut_agb_kf$finalModel, learn_cut_agb_west, Post_dist_stand_age, which.class, 
                                         plot = TRUE, add = FALSE,
...
ins_pd_stage3<-as.data.frame(partialPlot(model_ins_agb_kf$finalModel, learn_ins_agb_west, Post_dist_stand_age, which.class,
                                         plot = TRUE, add = FALSE,
...
fire_pd_seed_count3<-as.data.frame(partialPlot(model_fire_seed_kf$finalModel, learn_fire_seed_west, Pre_dist_seed_count, which.class, 
                                               plot = TRUE, add = FALSE,
...
cut_pd_seed_count3<-as.data.frame(partialPlot(model_cut_seed_kf$finalModel, learn_cut_seed_west, Pre_dist_seed_count, which.class, 
                                              plot = TRUE, add = FALSE,
...
ins_pd_seed_count3<-as.data.frame(partialPlot(model_ins_seed_kf$finalModel, learn_ins_seed_west, Pre_dist_seed_count, which.class,
                                              plot = TRUE, add = FALSE,
...
fire_pd_seed_age3<-as.data.frame(partialPlot(model_fire_seed_kf$finalModel, learn_fire_seed_west, Post_dist_stand_age, which.class, 
                                             plot = TRUE, add = FALSE,
...
cut_pd_seed_age3<-as.data.frame(partialPlot(model_cut_seed_kf$finalModel, learn_cut_seed_west, Post_dist_stand_age, which.class, 
                                            plot = TRUE, add = FALSE,
...
ins_pd_seed_age3<-as.data.frame(partialPlot(model_ins_seed_kf$finalModel, learn_ins_seed_west, Post_dist_stand_age, which.class,
                                            plot = TRUE, add = FALSE,
